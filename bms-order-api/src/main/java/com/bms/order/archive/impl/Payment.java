 ...
 */
public class Payment extends AbstractArchive implements Completable, Createable, Linkable, Modifiable, Deletable {
    ...
    /**
     * 构造函数，已过时，请使用Payment.build(blackboard).forComplete(id)
     *
     */
    
    public  Payment(Long id) {
        logger.info(this + "#Payment");
        Assert.notNull(id);
    ...
    /**
     * 构造函数，已过时，请使用Payment.build(blackboard).forCreate(entity,)
     *
     */
    ...
    public void complete(boolean allowDelete) {
        ...
        if (entity.getPaymentId() != null) {
            ...
            entity.setPaymentId(this.entity.getPaymentId());
            this.entity = entity;
        }
        ...
        PaymentEntity entity = dao.findOne(this.entity);
        if (entity == null)
            return;
        this.entity = entity;
    ...
    public String toString() {
        if (entity != null)
            return this.getClass().getName() + this.entity.getPaymentId();
        else
     ...
     *
     */
    public Payment forComplete(Long id) {
        logger.info(this + "#forComplete");
        Payment build = new Payment(id);
     ...
     *
     */
    public Payment forCreate(PaymentEntity entity) {
        logger.info(this + "#forCreate");
        Payment build = new Payment(entity);
        build.setBlackboard(blackboard);
        return build;
    }
