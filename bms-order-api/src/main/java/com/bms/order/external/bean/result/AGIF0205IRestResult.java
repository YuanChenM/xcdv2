 ...
 */
public class AGIF0205IRestResult implements Serializable {
    //买手领地关系id
    ...
    //批发市场个数
    private Long terminalMarketNum;
    //菜场个数(单位：个)
    private Long foodMarketNum;
    //餐饮聚集区个数(单位：个)
    private Long cookingGatheringNum;
    //团膳聚集区个数(单位：个)
    private Long mealsGatheringNum;
    //加工厂个数
    ...
    public Long getTerminalMarketNum() {
        return terminalMarketNum;
    }

    public void setTerminalMarketNum(Long terminalMarketNum) {
        this.terminalMarketNum = terminalMarketNum;
    }

    public Long getFoodMarketNum() {
        return foodMarketNum;
    }

    public void setFoodMarketNum(Long foodMarketNum) {
        this.foodMarketNum = foodMarketNum;
    }

    public Long getCookingGatheringNum() {
        return cookingGatheringNum;
    }

    public void setCookingGatheringNum(Long cookingGatheringNum) {
        this.cookingGatheringNum = cookingGatheringNum;
    }

    public Long getMealsGatheringNum() {
        return mealsGatheringNum;
    }

    public void setMealsGatheringNum(Long mealsGatheringNum) {
