...
*@author li_huiqian
*/
public class ORDR0804IBean extends RestBean {
private static final long serialVersionUID = 1L;
    ...
    private List<ORDR0804ShipIBean> shipList;
    ...
    public List<ORDR0804ShipIBean> getShipList() {
        return shipList;
    }

    public void setShipList(List<ORDR0804ShipIBean> shipList) {
