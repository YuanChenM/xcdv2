 ...
 */
public class InventoryQueryEntity implements Serializable {


    private List<InventoryQuery> inventoryQueryList;

    public List<InventoryQuery> getInventoryQueryList() {
        return inventoryQueryList;
    }

    public void setInventoryQueryList(List<InventoryQuery> inventoryQueryList) {
        this.inventoryQueryList = inventoryQueryList;
    }
