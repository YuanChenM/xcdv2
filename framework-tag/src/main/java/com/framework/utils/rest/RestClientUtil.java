package com.framework.utils.rest;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.TypeReference;
import com.alibaba.fastjson.serializer.SerializerFeature;
import com.framework.core.utils.StringUtils;
import com.framework.utils.Md5Digest;
...
public final class RestClientUtil {
     ...
     *
     */
    public static <T extends Serializable> T post(String url, Object param,
        TypeReference<T> typeReference, SerializerFeature... serializerFeature) {
    ...
    private static String post(String url, String jsonParam) {
        ...
        method.addHeader("api_key", RestClientUtil.getApiKey());
        method.addHeader("timestamp",timestamp);
        method.addHeader("security_key", Md5Digest.digest("admin" + timestamp + RestClientUtil.getSecurityKey()));
    ...
    public static void setApiKey(String apiKey) {
        RestClientUtil.apiKey = apiKey;
    }

    public static void setSecurityKey(String securityKey) {
        RestClientUtil.securityKey = securityKey;
    }
}
