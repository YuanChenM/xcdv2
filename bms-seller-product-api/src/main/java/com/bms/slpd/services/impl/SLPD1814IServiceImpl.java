...
import com.bms.slpd.dao.SLPD1814IDao;
...
@Service
public class SLPD1814IServiceImpl extends BaseServiceImpl implements SLPD1814IService {

    @Autowired
    private SLPD1814IDao slpd1814IDao;
    @Autowired
     ...
     */
    @Override
    public BaseRestPaginationResult<SLPD1806IManufacturerProducerProductResult> findManufacturerProducts(SLPD1814IParam slpd1814IParam) {
        BaseRestPaginationResult<SLPD1806IManufacturerProducerProductResult> restResult = super.findPageList(slpd1814IParam);
