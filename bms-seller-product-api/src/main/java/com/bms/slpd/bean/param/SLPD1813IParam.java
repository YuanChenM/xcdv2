...
@ApiModel(value = "SLPD1813IParam", description = "查询制造商未绑定的产品生产商API的入参")
public class SLPD1813IParam extends BaseRestPaginationParam {

    @ApiModelProperty(value = "制造商实体卖家ID集合")
    private List<Long> manufacturerEntitySellerIds;
    ...
    public List<Long> getManufacturerEntitySellerIds() {
        return manufacturerEntitySellerIds;
    }

    public void setManufacturerEntitySellerIds(List<Long> manufacturerEntitySellerIds) {
        this.manufacturerEntitySellerIds = manufacturerEntitySellerIds;
    }
