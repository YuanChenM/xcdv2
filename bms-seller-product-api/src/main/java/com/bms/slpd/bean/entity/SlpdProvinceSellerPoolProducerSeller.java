...
/**
 * <p>表SLPD_PROVINCE_SELLER_POOL_PRODUCER_SELLER对应的实体SlpdProvinceSellerPoolProducerSeller</p>
 *
 * @author 自动生成
 * @version 1.0.0
 */
public class SlpdProvinceSellerPoolProducerSeller extends BaseEntity {
    /** 序列号 */
     ...
     * <p>默认构造函数</p>
     */
    public SlpdProvinceSellerPoolProducerSeller() {
    }
