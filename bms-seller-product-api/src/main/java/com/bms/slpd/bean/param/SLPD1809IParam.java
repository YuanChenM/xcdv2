...
public class SLPD1809IParam extends BaseRestPaginationParam {
    ...
    @ApiModelProperty(value = "代理商产品生产商审核状态集合")
    ...
    public List<Long> getAgentSupplyIds() {
        return agentSupplyIds;
    }

    public void setAgentSupplyIds(List<Long> agentSupplyIds) {
        this.agentSupplyIds = agentSupplyIds;
    }

    public List<String> getAsProductCodes() {
        return asProductCodes;
    }

    public void setAsProductCodes(List<String> asProductCodes) {
        this.asProductCodes = asProductCodes;
    }

    public List<String> getAsAuditStus() {
        return asAuditStus;
    }

    public void setAsAuditStus(List<String> asAuditStus) {
        this.asAuditStus = asAuditStus;
    }
