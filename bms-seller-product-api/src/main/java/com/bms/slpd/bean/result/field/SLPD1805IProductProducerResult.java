...
@ApiModel(value = "SLPD1805IProductProducerResult", description = "产品生产商结果集")
public class SLPD1805IProductProducerResult implements Serializable {
	private static final long serialVersionUID = 1L;

	@ApiModelProperty(value = "单品品牌(规格)生产商ID")
	private Long producerProductId;
	@ApiModelProperty(value = "单品品牌(规格)生产商Code")
	private String producerProductCode;
	@ApiModelProperty(value = "单品品牌(规格)生产商SKU")
	private String producerProductSku;
	@ApiModelProperty(value = "单品品牌(规格)生产商审核状态，0：未审核，1：准入，2：禁止准入")
	private String auditStu;
	@ApiModelProperty(value = "单品品牌(规格)生产商审核状态")
	...
	private String productAuditStu;
	@ApiModelProperty(value = "审核状态")
	private String productAuditStuStr;
	...
	public String getProductAuditStu() {
		return productAuditStu;
	}

	public void setProductAuditStu(String productAuditStu) {
		this.productAuditStu = productAuditStu;
	}

	public String getProductAuditStuStr() {
		return productAuditStuStr;
	}

	public void setProductAuditStuStr(String productAuditStuStr) {
		this.productAuditStuStr = productAuditStuStr;
	}
