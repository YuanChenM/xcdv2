...
@ApiModel(value = "SLPD0805IProductResult", description = "产品")
public class SLPD0805IProductResult implements Serializable {
	...
	@ApiModelProperty(value = "产品生产商集合")
	private List<SLPD0805IProducerProductResult> producerProduct;
	...
	public List<SLPD0805IProducerProductResult> getProducerProduct() {
		return producerProduct;
	}

	public void setProducerProduct(List<SLPD0805IProducerProductResult> producerProduct) {
