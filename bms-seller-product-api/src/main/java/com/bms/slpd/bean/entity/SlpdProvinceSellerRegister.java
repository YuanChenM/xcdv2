...
/**
 * <p>表SLPD_PROVINCE_SELLER_REGISTER对应的实体SlpdProvinceSellerRegister</p>
 *
 * @author 自动生成
 * @version 1.0.0
 */
public class SlpdProvinceSellerRegister extends BaseEntity {
    /** 序列号 */
     ...
     * <p>默认构造函数</p>
     */
    public SlpdProvinceSellerRegister() {
    }
