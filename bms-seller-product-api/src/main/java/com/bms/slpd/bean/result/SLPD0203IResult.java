...
@ApiModel(value = "SLPD0203IResult", description = "修改品种接口出参")
public class SLPD0203IResult implements Serializable {
    ...
    @ApiModelProperty(value = "功能一返回值:更新一级分类Id列表")
    private List<Long> classesIds;
    @ApiModelProperty(value = "功能二返回值:更新二级分类Id列表")
    private List<Long> machiningIds;
    @ApiModelProperty(value = "功能三,功能四返回值:更新品种Id列表")
