...
@ApiModel(value = "SLPD1806IParam", description = "批量查询制造商单品品牌规格生产商API的入参")
public class SLPD1806IParam extends BaseRestPaginationParam {

    @ApiModelProperty(value = "制造商产品生产商ID集合")
    private List<Long> manufacturerProductIds;
    @ApiModelProperty(value = "制造商产品生产商编码集合")
    private List<String> manufacturerProductCodes;
    ...
    public List<String> getManufacturerProductCodes() {
        return manufacturerProductCodes;
    }

    public void setManufacturerProductCodes(List<String> manufacturerProductCodes) {
        this.manufacturerProductCodes = manufacturerProductCodes;
    }
