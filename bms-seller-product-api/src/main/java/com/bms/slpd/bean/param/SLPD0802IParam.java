...
@ApiModel(value = "SLPD0802IParam", description = "批量查询卖家单品品牌(规格)生产商API的入参")
public class SLPD0802IParam extends BaseRestPaginationParam {
	...
	public List<String> getSellerCommodityCodes() {
		return sellerCommodityCodes;
	}

	public void setSellerCommodityCodes(List<String> sellerCommodityCodes) {
		this.sellerCommodityCodes = sellerCommodityCodes;
	}
