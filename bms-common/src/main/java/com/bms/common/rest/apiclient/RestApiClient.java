 ...
 * @author li_huiqian
 */
public class RestApiClient extends AbstractApiRestClient {
    private static Logger logger = LoggerFactory.getLogger(RestApiClient.class);

    private ResponseEntity<String> responseEntity;

    private  RestTemplate restTemplate;
    protected RestApiClient(int connectTimeout, int readTimeout, int asyncConnectTimeout, int asyncReadTimeout,String apiKey,String securityKey,RestTemplate restTemplate) {
     ...
     * Demo:<br>
     * <code>
     * RestApiClient client = RestClientFactory.newRestClient();<br>
     ...
     * <p>
     * Demo:<br>
     * <code> RestApiClient client = RestClientFactory.newRestClient();<br>
