 ...
 * @author li_huiqian
 */
public abstract class AbstractBatchRestClient {
    ...
    protected AbstractBatchRestClient(int connectTimeout, int readTimeout, int asyncConnectTimeout, int asyncReadTimeout,String apiKey,String securityKey) {
     ...
     * @param requestEntity
     */
    protected abstract void executePost(String url, Object requestEntity, String batchId,String[] showField, String[] hideField);
     ...
     * @return
     */
    protected HttpEntity<String> createFormData(Object requestEntity, String batchId,String[] showField, String... hideField) {
        /* 构造表单数据 */
        String json = JsonUtil.serialize(requestEntity);
        return new HttpEntity<String>(json, createRequestHeaders(batchId,showField, hideField));
    }
     ...
     * @return
     */
    private HttpHeaders createRequestHeaders(String batchId,String[] showField, String... hideField) {
        /* HTTP头部 */
        ...
        headers.add("sign",batchId);
        Date date = new Date();
        String timestamp = String.valueOf(date.getTime());
        headers.add("api_key", this.apiKey);
        headers.add("timestamp", timestamp);
        headers.add("security_key", Md5RestDigest.digest(batchId,this.securityKey,timestamp));
