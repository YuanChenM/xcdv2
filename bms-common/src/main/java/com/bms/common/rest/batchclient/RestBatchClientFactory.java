...
@Component
public class RestBatchClientFactory {
    ...
    public RestBatchClient newBatchRestClient() {
        if (null == restTemplate) {
            restTemplate = getRestTemplate();
        }
        return new RestBatchClient(connectTimeout, readTimeout, asyncConnectTimeout, asyncReadTimeout, apiKey, securityKey,restTemplate);
    }

    public AsyncBatchRestClient newAsyncRestBatchClient() {
        if(null == asyncRestTemplate){
            asyncRestTemplate = getAsyncRestTemplate();
        }
        return new AsyncBatchRestClient(connectTimeout, readTimeout, asyncConnectTimeout, asyncReadTimeout, apiKey, securityKey,asyncRestTemplate);
    }
