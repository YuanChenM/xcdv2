...
@EnableEurekaClient
public class BmsBuyerInformationApiApplication {

    public static void main(String[] args) {
        SpringApplication application = new SpringApplication(BmsBuyerInformationApiApplication.class);
