...
public class BuyerOrderEntity {
     ...
     * 买家分批订单
     */
    private List<BuyerBatchOrderEntity> batchOrders;

    /**
     * @return the batchOrders
     */
    public List<BuyerBatchOrderEntity> getBatchOrders() {
        return batchOrders;
    }
     ...
     */
    public void setBatchOrders(List<BuyerBatchOrderEntity> batchOrders) {
    ...
    public String getOrderPlaceDatetime() {
        return DateUtils.format(DateUtils.FORMAT_YYYY_MM_DD_HH_MM_SS, this.orderPlaceDatetime);
    }
