 ...
 *
 */
public class BuyerBatchOrderEntity {

    /**
     * 分批订单明细
     */
    private List<BuyerBatchOrderDetailEntity> batchOrderDetails;

    /**
     * @return the batchOrderDetails
     */
    public List<BuyerBatchOrderDetailEntity> getBatchOrderDetails() {
     ...
     */
    public void setBatchOrderDetails(List<BuyerBatchOrderDetailEntity> batchOrderDetails) {
