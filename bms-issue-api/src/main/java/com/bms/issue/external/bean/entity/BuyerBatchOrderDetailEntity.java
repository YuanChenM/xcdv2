 ...
 *
 */
public class BuyerBatchOrderDetailEntity {

    private List<BuyerForcastDeliverDetailEntity> forcastDeliverDetails;

    /**
     * @return the ordrBuyerForcastDeliverDetails
     */
    public List<BuyerForcastDeliverDetailEntity> getOrdrBuyerForcastDeliverDetails() {
        return forcastDeliverDetails;
    }

    /**
     * @param forcastDeliverDetails
     *            the ordrBuyerForcastDeliverDetails to set
     */
    public void setOrdrBuyerForcastDeliverDetails(List<BuyerForcastDeliverDetailEntity> forcastDeliverDetails) {
        this.forcastDeliverDetails = forcastDeliverDetails;
    }
