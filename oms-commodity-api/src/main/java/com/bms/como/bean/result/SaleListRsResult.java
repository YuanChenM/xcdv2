...
public class SaleListRsResult implements Serializable {
    ...
    private boolean isIsOpenToAgent;
...
//    private Long shelfDetailId;
    ...
    /**
     * 商品组成明细表，指定特殊生产商/批次时才会提供该部分数据
     * COMO_COMMODITY_DETAIL
     */
    @ApiModelProperty(value = "商品组成明细集合")
    private List<CommodityDetailRsResult> detailList;

    public boolean isIsOpenToAgent() {
        return isIsOpenToAgent;
    }

    public void setIsOpenToAgent(boolean isIsOpenToAgent) {
        this.isIsOpenToAgent = isIsOpenToAgent;
    }
    ...
    public List<CommodityDetailRsResult> getDetailList() {
        return detailList;
    }

    public void setDetailList(List<CommodityDetailRsResult> detailList) {
