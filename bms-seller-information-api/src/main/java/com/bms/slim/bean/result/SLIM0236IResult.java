...
@ApiModel(value = "SLIM0236IResult",description = "修改生产商实验室接口出参")
public class SLIM0236IResult implements Serializable {
    private static final long serialVersionUID = 1L;

    @ApiModelProperty(value = "返回消息")
    private String[] message;
    @ApiModelProperty(value = "修改生产商实验室数量")
    private Integer count;
    @ApiModelProperty(value = "修改生产商实验室ID结果集")
