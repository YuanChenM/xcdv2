...
/**
 * <p>表SLIM_SELLER_BUSINESS_TEAM对应的实体SlimSellerBusinessTeam</p>
 *
 * @author 自动生成
 * @version 1.0.0
 */
public class SlimSellerBusinessTeam extends BaseEntity {
    /** 序列号 */
