...
@ApiModel(value = "SLIM0231IResult", description = "新增生产商库容接口出参")
public class SLIM0231IResult implements Serializable {
    private static final long serialVersionUID = 1L;
    @ApiModelProperty(value = "返回消息")
    private String[] message;
    @ApiModelProperty(value = "新增生产商库容数量")
    private Integer count;
    @ApiModelProperty(value = "新增生产商库容ID结果集")
