...
@ApiModel(value = "SLIM0250IParam", description = "批量查询卖方单位API的参数")
public class SLIM0250IParam extends BaseRestPaginationParam {
    ...
    @ApiModelProperty(value = "实体卖家CODE集合")
    private List<String> entitySellerCodes;
    @ApiModelProperty(value = "实体卖家显示编码")
    private String entitySellerDisplayCode;
    @ApiModelProperty(value = "实体卖家CODE(用于模糊查询)")
