...
@ApiModel(value = "SLIM0250IEntitySellerResult", description = "实体卖家")
public class SLIM0250IEntitySellerResult implements Serializable {
    private static final long serialVersionUID = 1L;

    @ApiModelProperty(value = "实体卖家ID")
    private Long entitySellerId;
	@ApiModelProperty(value = "实体卖家系统Code")
