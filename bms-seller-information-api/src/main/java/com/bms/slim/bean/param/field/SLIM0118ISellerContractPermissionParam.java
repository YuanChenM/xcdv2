...
@ApiModel(value = "SLIM0118ISellerContractPermissionParam", description = "卖家合同信息")
public class SLIM0118ISellerContractPermissionParam implements Serializable {
    private static final long serialVersionUID = 1L;
    @ApiModelProperty(value="合同准入Id")
    private Long scpId;
