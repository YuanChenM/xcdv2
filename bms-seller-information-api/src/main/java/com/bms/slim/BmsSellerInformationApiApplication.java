...
@EnableEurekaClient
public class BmsSellerInformationApiApplication {

    public static void main(String[] args) {
            SpringApplication application = new SpringApplication(BmsSellerInformationApiApplication.class);
