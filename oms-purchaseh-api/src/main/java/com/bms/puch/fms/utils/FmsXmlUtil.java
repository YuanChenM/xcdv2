...
import com.bms.puch.fms.bean.FmsRequestData;
import com.bms.puch.fms.bean.FmsResult;
...
public final class FmsXmlUtil {
    ...
    public static <T extends Serializable> String CreateFmsXmlParam(String pushOrderType, List<T> beans) {
        FmsRequestData<T> fmsRequestData = FmsXmlUtil.CreateFmsRequestData(beans);
        String xmlParam = FmsXmlUtil.CreateFmsXmlParam(pushOrderType, fmsRequestData);
        return xmlParam;
    }
