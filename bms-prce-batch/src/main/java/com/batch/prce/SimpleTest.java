...
@ComponentScan(basePackages = { "com.batch.prce", "com.framework.batch", "com.bms", "com.framework.aop",
...
public class SimpleTest {
    ...
    public static void main(String[] args) throws Exception {
        SpringApplication application = new SpringApplication(SimpleTest.class);
