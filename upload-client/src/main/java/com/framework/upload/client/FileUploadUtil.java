package com.framework.upload.client;


import com.alibaba.fastjson.util.IOUtils;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.framework.core.utils.StringUtils;
import com.framework.upload.constValue.NumberConst;
import com.framework.upload.constValue.StringConst;
import com.framework.upload.util.FileUtils;
...
public class FileUploadUtil {
    ...
    public static String FILE_SERVICE_URL;
    ...
    public static Map<String, String> uploadFiles(Map<String, File> files) throws Exception {
        ...
        for (String key : files.keySet()) {
            ...
            byte[] data = toByteArray(new FileInputStream(files.get(key)));
            //文件不得大于40M
            if(data.length >= 40*1024*1024){
                throw new Exception("文件大于40M");
            }
