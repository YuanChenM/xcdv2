 ...
 */
@ApiModel(value = "BuyerButlerAgentRelationRsPageParam", description = "买家所属的买手和管家信息查询参数")
public class BuyerButlerAgentRelationRsPageParam extends BaseRestPaginationParam {
