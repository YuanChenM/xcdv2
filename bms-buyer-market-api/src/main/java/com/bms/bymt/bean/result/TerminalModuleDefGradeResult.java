 ...
 */
@ApiModel(value = "TermGradeInfoResult", description = "返回对象")
public class TerminalModuleDefGradeResult implements Serializable {
    ...
    @ApiModelProperty(value = "目标买家消费卖家数(单位:户)")
