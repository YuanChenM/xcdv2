...
public final class RestClientUtils {
     ...
     *
     */
    public static <T extends Serializable> RestResponse<T> post(String url, Object param,
        TypeReference<RestResponse<T>> typeReference, SerializerFeature... serializerFeature) {
