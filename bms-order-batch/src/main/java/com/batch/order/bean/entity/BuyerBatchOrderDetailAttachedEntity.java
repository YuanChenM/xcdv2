...
public class BuyerBatchOrderDetailAttachedEntity extends BaseEntity {
...
/** 商品：单品品牌编码 [卖家产品：单品品牌SKU] */
private String itemBrandCode;
/**
* 获取商品：单品品牌编码 [卖家产品：单品品牌SKU]
* @return 商品：单品品牌编码 [卖家产品：单品品牌SKU]
*/
public String getItemBrandCode() {
return this.itemBrandCode;
}
/**
* 设置商品：单品品牌编码 [卖家产品：单品品牌SKU]
* @param itemBrandCode
*/
