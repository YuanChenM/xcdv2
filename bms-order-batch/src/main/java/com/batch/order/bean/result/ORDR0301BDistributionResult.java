...
@XmlType(propOrder = {"orderline","sku","inboundBatch","uom","consignee","area","company","qtyoriginal","inputQty","attributes","inventoryStatus"})
public class ORDR0301BDistributionResult {
