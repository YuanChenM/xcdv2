 ...
 */
public class ORDR0303BItemProcessor implements BaseItemProcessor<BaseRestParam, BaseRestParam> {
    /** 日志 */
    private static final Logger logger = LoggerFactory.getLogger(ORDR0303BItemProcessor.class);
