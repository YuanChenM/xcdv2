 ...
 */
public class ORDR0302BItemProcessor implements BaseItemProcessor<BaseRestParam, BaseRestParam> {
    /** 日志 */
    private static final Logger logger = LoggerFactory.getLogger(ORDR0302BItemProcessor.class);
