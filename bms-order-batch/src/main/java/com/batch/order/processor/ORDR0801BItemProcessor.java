 ...
 */
public class ORDR0801BItemProcessor implements BaseItemProcessor<BaseRestParam, BaseRestParam> {
    /** 日志 */
    private static final Logger logger = LoggerFactory.getLogger(ORDR0801BItemProcessor.class);
