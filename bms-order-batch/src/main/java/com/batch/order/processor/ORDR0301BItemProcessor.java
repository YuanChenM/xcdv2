 ...
 */
public class ORDR0301BItemProcessor implements BaseItemProcessor<BaseRestParam, BaseRestParam> {
    /** 日志 */
    private static final Logger logger = LoggerFactory.getLogger(ORDR0301BItemProcessor.class);
