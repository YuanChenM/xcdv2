 ...
 */
public class ORDR0101BItemWriter extends MybatisItemWriter<BaseRestParam> {
    /** 日志 */
    private static final Logger logger = LoggerFactory.getLogger(ORDR0101BItemWriter.class);
