 ...
 */
public class ORDR0301BItemWriter extends MybatisItemWriter<BaseRestParam> {
    /** 日志 */
    private static final Logger logger = LoggerFactory.getLogger(ORDR0301BItemWriter.class);
