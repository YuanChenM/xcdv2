 ...
 */
public class ORDR0302BItemWriter extends MybatisItemWriter<BaseRestParam> {
    /** 日志 */
    private static final Logger logger = LoggerFactory.getLogger(ORDR0302BItemWriter.class);
