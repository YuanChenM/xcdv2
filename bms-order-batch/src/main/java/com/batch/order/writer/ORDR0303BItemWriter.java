 ...
 */
public class ORDR0303BItemWriter extends MybatisItemWriter<BaseRestParam> {
    /** 日志 */
    private static final Logger logger = LoggerFactory.getLogger(ORDR0303BItemWriter.class);
