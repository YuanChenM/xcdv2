...
/**
 * <p>表invm_product_info对应的实体InvmProductInfo</p>
 *
 * @author 自动生成
 * @version 1.0.0
 */
public class InvmProductInfo extends BaseEntity {
    /** 序列号 */
     ...
     * <p>产品等级编码</p>
     *
     * @param qualityGradeTypeCode 产品等级编码
     */
