...
/**
 * <p>表invm_load_aloc_deal_detail对应的实体InvmLoadAlocDealDetail</p>
 *
 * @author 自动生成
 * @version 1.0.0
 */
public class InvmLoadAlocDealDetail extends BaseEntity {
    /** 序列号 */
